...
public class SecurityConfig extends KeycloakWebSecurityConfigurerAdapter {
    ...
    public void configureGlobal(AuthenticationManagerBuilder auth, UserService userService) {
        ...
        CustomKeycloakAuthenticationProvider customKeycloakAuthenticationProvider = new CustomKeycloakAuthenticationProvider(userService);
        customKeycloakAuthenticationProvider.setGrantedAuthoritiesMapper(grantedAuthorityMapper);
